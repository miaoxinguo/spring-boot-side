...
public class CustomerCommentGenerator implements CommentGenerator {
    ...
    /** 添加数据库的注释。 如果 suppressAllComments 为 true，忽略该配置*/
    private boolean addRemarkComments;

    private SimpleDateFormat dateFormat;

    /**
     * Instantiates a new customer comment generator.
     */
    ...
    public void addFieldComment(Field field,
        ...
        field.addJavaDocLine(" *"); //$NON-NLS-1$
        field.addJavaDocLine(" * 该属性由 Mybatis-Generator 自动创建，不要直接修改."); //$NON-NLS-1$
    ...
    public void addGeneralMethodComment(Method method, IntrospectedTable introspectedTable) {
        ...
        method.addJavaDocLine(" * 该方法由 Mybatis-Generator 自动创建，不要修改 "); //$NON-NLS-1$
    ...
    private void addGetterAndSetter(Method method) {
        if (suppressAllComments) {
            return;
        }

        method.addJavaDocLine("/**");
        method.addJavaDocLine(" * 该方法由 Mybatis-Generator 自动生成，不要修改."); //$NON-NLS-1$
